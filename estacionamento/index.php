...
<body id="bodyindex">
    ...
    <div class="container">
        ...
        <div class=" d-flex justify-content-center  ">
            ...
            <div class="card " >
                <p ><h3 style="color: white;text-align: center;">EJC.Estacionamento </h3></p>
                <div class="card-header">
                    <div class="col-md-6"><img src='img/carro.png' style='height:70%; width:80%; margin-left:130px;'></div>
                ...
                <div class="card-body">
                    <form method="post" action="index.php">
                        ...
                        <div class="form-group">
                            <input type="submit" value="enter" name="entrar" class="btn float-right login_btn">
                        </div>
                    </form>
                </div>
